...
try:
    ...
    original_data = pandas.read_csv("data/serbian_words.csv")
...
def next_card():
    ...
    canvas.itemconfig(card_title, text="Serbian", fill="black")
    canvas.itemconfig(card_word, text=current_card["Serbian"], fill="black")
